...
{
    public class ActiveAlert : TenantAware, ITenantAware, IFranchiseAware
    {
        public ActiveAlert()
        {
            AlertBlobs = new HashSet<ActiveAlertBlob>();
            AlertActivities = new HashSet<ActiveAlertActivity>();
        }
        ...
        [Display(Name = "Open Date", Description = "Alert Open Date")]
        ...
        [DisplayFormat(DataFormatString = StandardDateTimeFormats.Full)]
        [Display(Name = "Last Date", Description = "Alert Last Date")]
        ...
        public virtual ICollection<ActiveAlertBlob> AlertBlobs { get; set; }
        public virtual ICollection<ActiveAlertActivity> AlertActivities { get; set; }
    }
}